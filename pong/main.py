...
class Game():
    def __init__(self):
        ...
        pygame.display.set_caption("Kory's Pong")
    ...
    def display_score(self):
        player_surf = self.font.render(str(self.player_score),True,'pink')
        ...
        cpu_surf = self.font.render(str(self.cpu_score),True,'pink')
        ...
        pygame.draw.line(self.display_surface, 'pink', start, end, 10)
